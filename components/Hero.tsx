    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-5 pb-20 pt-16 sm:px-8 sm:pt-24">
        ...
        >
          ...
          <a
            href="/instructors"
            className="press inline-flex items-center justify-center gap-1.5 rounded-full bg-sea px-6 py-3 text-base font-semibold text-white shadow-sm transition-transform hover:-translate-y-0.5 hover:bg-sea-dark"
          >
            Find lessons
