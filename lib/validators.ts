...
export const instructorProfileSchema = z.object({
  ...
  transmission: z.enum(["MANUAL", "AUTOMATIC", "BOTH"]),
  hourlyRate: z.coerce.number().int().min(1, "Enter your hourly rate"),
  carMake: z.string().max(40).optional(),
  carModel: z.string().max(40).optional(),
  carYear: z.coerce.number().int().min(1980).max(2100).optional(),
  carColour: z.string().max(30).optional(),
  carDetails: z.string().max(120).optional(),
  bio: z.string().max(400).optional(),
